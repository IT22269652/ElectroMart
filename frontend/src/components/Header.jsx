...
const Header = () => {
  ...
  const products = [
    ...
    { id: "4", name: "Sony TV", price: "$799", image: assets.SonyTV01, category: "TV" },
    { id: "5", name: "DSLR Camera", price: "$799", image: assets.camera01, category: "Camera" },
    { id: "6", name: "Mirrorless Camera", price: "$899", image: assets.camera02, category: "Camera" },
    { id: "7", name: "Action Camera", price: "$299", image: assets.camera03, category: "Camera" },
    { id: "8", name: "Instant Camera", price: "$199", image: assets.camera04, category: "Camera" },
    { id: "9", name: "Gaming Laptop", price: "$1299", image: assets.laptop01, category: "Laptop" },
    { id: "10", name: "Ultrabook", price: "$1099", image: assets.laptop02, category: "Laptop" },
    { id: "11", name: "2-in-1 Laptop", price: "$899", image: assets.laptop03, category: "Laptop" },
    { id: "12", name: "Business Laptop", price: "$999", image: assets.laptop04, category: "Laptop" },
    { id: "13", name: "iPhone 14 Pro", price: "$999", image: assets.Iphone01, category: "iPhone" },
