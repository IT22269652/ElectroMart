  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <h2 className="text-xl font-semibold text-gray-700 mb-2">Product Management</h2>
          <p className="text-gray-500 text-center mb-4">
            Update inventory, manage product details, categories, and handle availability.
          </p>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center justify-between hover:shadow-xl transition-shadow">
          <h2 className="text-xl font-semibold text-gray-700 mb-2">Customer Management</h2>
          <p className="text-gray-500 text-center mb-4">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center justify-between hover:shadow-xl transition-shadow">
          <h2 className="text-xl font-semibold text-gray-700 mb-2">Customer Feedback Management</h2>
          <p className="text-gray-500 text-center mb-4">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center justify-between hover:shadow-xl transition-shadow">
          <h2 className="text-xl font-semibold text-gray-700 mb-2">Payment Management</h2>
          <p className="text-gray-500 text-center mb-4">
            Track product sales, process refunds, and review payment analytics for your store.
          </p>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center justify-between hover:shadow-xl transition-shadow">
          <h2 className="text-xl font-semibold text-gray-700 mb-2">Delivery Management</h2>
          <p className="text-gray-500 text-center mb-4">
            Track product shipments, manage delivery partners, and monitor delivery statuses.
          </p>
